...
nu_max_distr = lambda: random.uniform(0, 2e-2)
...
I0_distr = lambda: random.uniform(1e-4, 0.3)
...
for i in range(samples):
    ...
    file.write("%1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, \
%1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, \
%1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.5f, \
%1.5f, %1.5f, %1.5f, %1.5f, %1.5f, %1.9f, %1.9f, %1.9f, %1.9f, %d, %d \n" %
    (beta, betap, betapp, beta_1, beta_1p, beta_1pp, \
    beta_2, beta_2p, beta_2pp, nu_max, eta_1, eta_2, \
    gamma, gammap, gammapp, sigma, sigma_1, sigma_2, IFR, IFR1, IFR2, td, \
    S0, S0p, S0pp, E0, E0p, E0pp, I0, I0p, I0pp, R0, D0, \
